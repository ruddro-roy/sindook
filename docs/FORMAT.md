...
Integers are big-endian, sizes in bytes. Format v2 is written by sindook 0.2.0 and later; v1 files remain supported and are covered by golden fixtures in the test suite. The literature basis and the project decisions behind this layout are in [DESIGN_RATIONALE.md](DESIGN_RATIONALE.md).
