...
#   shasum -a 256 sindook_0.6.0_darwin_amd64.tar.gz
#   shasum -a 256 sindook_0.6.0_darwin_arm64.tar.gz
class Sindook < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "" # shasum -a 256 sindook_0.6.0_darwin_amd64.tar.gz
    else
      ...
      sha256 "" # shasum -a 256 sindook_0.6.0_darwin_arm64.tar.gz
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      sha256 "" # shasum -a 256 sindook_0.6.0_linux_amd64.tar.gz
    else
      ...
      sha256 "" # shasum -a 256 sindook_0.6.0_linux_arm64.tar.gz
    end
  end
